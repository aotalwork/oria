...
ActiveRecord::Schema[8.1].define(version: 2026_08_11_105738) do
  ...
  create_table "procrastinations", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_procrastinations_on_user_id"
  end
  ...
  add_foreign_key "procrastinations", "users"
